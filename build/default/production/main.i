...
unsigned char I2C_LEITURA (unsigned char ADRR, unsigned char addr)
{
 char x;
 unsigned char DADO_I2C;
 x = I2C_LIVRE();
 if (x == 0)
 {
  I2C_STOP();
...
char verifica_senha(char vet[]) {
    ...
    a = LEITURA_24C08(ENDH, 0);
    b = LEITURA_24C08(ENDH, 1);
    c = LEITURA_24C08(ENDH, 2);
    d = LEITURA_24C08(ENDH, 3);
    if (vet[0] == a && vet[1] == b && vet[2] == c && vet[3] == d) {
        pos = 0;
        return 'i';
    }

    a = LEITURA_24C08(ENDH, 4);
    ...
    while (1) {
        ...
        switch (tecla) {
            case '1':
                ...
                resp = verifica_senha(senha_cadastro);
            ...
            case '2':
                ...
                _delay((unsigned long)((1000)*(8000000/4000.0)));
                sendCMD(0x01);
                resp = verifica_senha(senha_login);
            ...
            case '3':
                ...
                _delay((unsigned long)((1000)*(8000000/4000.0)));
                resp = verifica_senha(senha_excluir);
                ...
                if (resp == 'i') {
                    ...
                    posex = pos;
                    for (int i = pos + 4; i < 20; i++) {
                        aux = LEITURA_24C08(ENDH, i);
